...
namespace XNetCore.MyBatis.DataMapper.Exceptions
{
	/// <summary>
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="XNetCore.MyBatis.DataMapper.Exceptions.DataMapperException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="XNetCore.MyBatis.DataMapper.Exceptions.DataMapperException"/> 
