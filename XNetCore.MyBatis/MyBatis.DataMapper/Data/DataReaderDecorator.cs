...
namespace XNetCore.MyBatis.DataMapper.Data
{
    ...
    public sealed class DataReaderDecorator : IDataReader
    {
        ...
        {
            return DataHandler.Instance.getDbDecimal(_innerDataReader.GetDecimal(i));
        }
        ...
        {
            return DataHandler.Instance.getDbDouble(_innerDataReader.GetDouble(i));
        }
        ...
        {
            return DataHandler.Instance.getDbFloat(_innerDataReader.GetFloat(i));
        }
